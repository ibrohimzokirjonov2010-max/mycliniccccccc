...
- **Qanday tuzatildi:** Faktura `createdPlan.doctor_name` / bemorning `main_treatment_provider` ini chiqaradi. Implant yozuvi ham biriktirilgan shifokor bor bo'lsa admin muhrini almashtiradi.
