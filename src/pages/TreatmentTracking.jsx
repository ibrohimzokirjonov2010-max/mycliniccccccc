    ...
    <div className="space-y-4 pb-24 sm:pb-10 bg-slate-50/30 min-h-screen -m-4 p-4 sm:m-0 sm:p-0">
      ...
      <div className="px-1 sm:px-0">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-black text-slate-900 tracking-tight">Davolash Kuzatuvi</h1>
            <p className="text-[10px] font-bold text-slate-400 mt-0.5 uppercase tracking-wider">
              Jarayonlar monitoringi va tahlili
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 px-1 sm:px-0">
        {[
          { label: "Jami", value: total, icon: Target, color: "text-slate-600", bg: "bg-slate-50", border: "border-slate-100" },
          { label: "Bajarildi", value: completed, icon: CheckCircle2, color: "text-emerald-600", bg: "bg-emerald-50", border: "border-emerald-100" },
          { label: "Jarayonda", value: inProgress, icon: Clock, color: "text-orange-600", bg: "bg-orange-50", border: "border-orange-100" },
          { label: "Reja", value: planned, icon: Calendar, color: "text-blue-600", bg: "bg-blue-50", border: "border-blue-100" },
        ].map((s, i) => (
          <motion.div 
            key={s.label}
            ...
            className="bg-white border border-slate-100 rounded-xl p-3.5 flex items-center gap-3 shadow-sm relative group overflow-hidden"
          >
      ...
      >
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-[11.5px] font-bold text-slate-850 uppercase tracking-wider">Umumiy samaradorlik</h3>
          </div>
      ...
      <div className="space-y-3 px-1 sm:px-0">
        <h3 className="text-[11px] font-bold text-slate-500 uppercase tracking-wider ml-1">Jarayondagi ishlar</h3>
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-slate-100 p-8 text-center shadow-sm">
            <EmptyState icon={Activity} title="Rejalar mavjud emas" description="Hozircha kuzatuv ostida hech qanday reja yo'q" />
          </div>
        ) : (
                ...
                <table className="w-full text-left border-collapse table-fixed min-w-[850px]">
                  <thead>
                    <tr className="bg-slate-50/50 border-b border-slate-100">
                      <th className="px-4 py-3 text-[10px] font-bold text-slate-500 uppercase tracking-wider w-[28%] min-w-[200px]">Reja nomi / Bemor</th>
                      <th className="px-4 py-3 text-[10px] font-bold text-slate-500 uppercase tracking-wider w-[24%] min-w-[170px]">Reja ijrosi</th>
                      <th className="px-4 py-3 text-[10px] font-bold text-slate-500 uppercase tracking-wider w-[14%] min-w-[100px]">Qiymati</th>
                      <th className="px-4 py-3 text-[10px] font-bold text-slate-500 uppercase tracking-wider w-[18%] min-w-[130px]">Status</th>
                        ...
                        <td className="px-4 py-2.5 w-[18%] min-w-[130px]">
                          ...
                          >
                            ...
                            <SelectContent className="rounded-xl border-slate-100">
                              <SelectItem value="Rejalashtirilgan" className="text-[9.5px] font-bold uppercase tracking-wider text-blue-700">Rejalashtirilgan</SelectItem>
                              <SelectItem value="Jarayonda" className="text-[9.5px] font-bold uppercase tracking-wider text-orange-700">Jarayonda</SelectItem>
                              <SelectItem value="Yakunlangan" className="text-[9.5px] font-bold uppercase tracking-wider text-emerald-700">Yakunlangan</SelectItem>
                            </SelectContent>
                          </Select>
                        </td>
                    ...
                    <div className="p-3.5">
                      <div className="flex items-start justify-between mb-3 gap-2">
                        ...
                        <div className="text-right shrink-0">
                          <p className="text-[8px] font-bold text-slate-400 uppercase tracking-wider mb-0.5 leading-none">Qiymati</p>
                        ...
                        >
                          <SelectTrigger 
                            className={`h-7 px-2.5 py-0 rounded-lg text-[9px] font-bold uppercase tracking-wider border outline-none w-[120px] ${
                              ...
                              p.status === 'Jarayonda' || p.status === 'In Progress' ? 'bg-orange-50 text-orange-700 border-orange-150' :
                          ...
                          <SelectContent className="rounded-xl border-slate-100">
                            <SelectItem value="Rejalashtirilgan" className="text-[10px] font-bold">Rejalashtirilgan</SelectItem>
                            <SelectItem value="Jarayonda" className="text-[10px] font-bold">Jarayonda</SelectItem>
                            <SelectItem value="Yakunlangan" className="text-[10px] font-bold">Yakunlangan</SelectItem>
                          </SelectContent>
                        </Select>
