...
assert(entry.includes('data-testid="implant-wizard-diameter"'), 'diameter field on the tooth panel');
assert(entry.includes('data-testid="implant-wizard-length"'), 'length field on the tooth panel');
