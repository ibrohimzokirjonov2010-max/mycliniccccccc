-- Supabase Database Schema for Dental Clinic
...
-- For now, we'll keep tables accessible (you can add RLS later)

-- Example RLS policy (uncomment and modify as needed):
-- ALTER TABLE clinics ENABLE ROW LEVEL SECURITY;
-- CREATE POLICY "Clinics are viewable by authenticated users" ON clinics FOR SELECT USING (true);
...
-- Apply trigger to tables with updated_date
